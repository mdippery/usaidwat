...
To list a count of subreddits in which a user has posted:

bc. # usaidwat where jedberg
...
To see the comments for a specific subreddit:

bc. $ usaidwat list jedberg funny

All the comments for the given subreddit will be printed.

Other available commands can be shown simply by running @usaidwat@.