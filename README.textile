**The Ruby version of this tool is no longer actively developed. For the newest, actively-developed version of this tool, download the Rust implementation "usaidwat":https://github.com/mdippery/usaidwat-next from crates.io.**
